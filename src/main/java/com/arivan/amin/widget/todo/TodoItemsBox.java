...
public class TodoItemsBox extends VBox
{
    ...
    @NotNull
    public static TodoItemsBox newInstance ()
    {
        return new TodoItemsBox();
    }
    ...
    {
        return "TodoItemsBox{" + "textField=" + textField + '}';
    }
}
